module ForemanImageBuilder
  module BlueprintsHelper
    def permitted_blueprint_actions(blueprint)
      ...
      actions << link_to(_("Build"), foreman_image_builder.build_blueprint_path(blueprint.to_param), method: :post, data: { confirm: _("Are you sure you want to build this blueprint?") })
      actions
    end
  end
end
